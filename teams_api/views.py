...
from teams_api.graph_helper import get_user, get_calendar_events, get_channels
...
def initialize_context(request):
  ...
  context['user1'] = request.session.get('user', {'is_authenticated': False})
  return context
